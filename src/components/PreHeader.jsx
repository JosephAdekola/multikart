...
export default function PreHeader() {
    ...
    return (
        <div>
            <div className={`${!staticDropDownState ? 'hidden' : 'absolute top-0 left-0 h-[100vh] w-[300px] bg-white z-10'}`}>
                    <StaticDropDownMenu />
            </div>
            <div className={` lg:hidden ${!responsiveMenu ? 'hidden' : 'absolute top-0 right-0 h-[100vh] w-[300px] bg-white z-10'}`}>
                    <ResponsiveMainMenu />
                </div>
            <div className={`hidden lg:block md:block w-full h-[5vh] bg-[#f8f8f8]`}>
                ...
                <div className=' max-w-[1400px] flex justify-end lg:justify-between mx-auto h-full 
                    ...
                    <div className=' flex gap-5 my-auto relative  '>
